...
class RotatedDeformableDETRHead(DeformableDETRHead, RotatedDETRHead):
    ...
    def _init_layers(self) -> None:
        ...
        # The inherited DeformableDETRHead sets reg bias[2:] = -2.0 (small
        # box prior). For rotated boxes the 5th dim (angle) also needs that
        # small-value prior, so re-apply on the reg head and run init.
        self.init_weights()
    ...
    def forward(self, hidden_states: Tensor,
        ...
        Returns:
            ...
            - all_layers_outputs_classes (Tensor): Outputs from the cls head.
            - all_layers_outputs_coords (Tensor): Sigmoid outputs from the
              regression head with normalized coordinate format (cx, cy, w,
              h, rad), has shape (num_decoder_layers, bs, num_queries, 5).
        """
