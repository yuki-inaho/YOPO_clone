"""Fine-tune the compact Stage-4 RGB-D model on the TMT4-02 export.
...
Stage-4 CoP-chain objective and performs model-only transfer: optimizer state
from the 2025+2026 curriculum is not valid for this smaller target dataset.
