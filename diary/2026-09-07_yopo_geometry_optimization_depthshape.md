...
- ユーザー判断による主採用はDepth-to-shapeを含む **G epoch 10**。HBB `.871735`、
  ellipse `.872072`、projection `.850226`、shared `.313780`、strict `.236604`。
- shared重視のPareto代替はgeometry FP32だけを加えた **D epoch 15**。181枚独立評価で
  HBB `.863438`、ellipse `.864990`、projection `.846640`、shared AP25 `.353354`、
  strict 3D AP25 `.220186`、ray median `7.6803 mm`。
- D15はshared、G10はstrictが高く相互非支配である。2026-09-07のユーザー判断で、
  strict 3Dの高いG10を現行主採用、D15をshared向け代替とした。
...
| 4. Depth query→shape | E比shared `+.003241`、G10 strict `.236604` | 主採用 |
...
| D15 shared alternative | `e9851c71d2dea2dfebff4beb4d1a2392d88ba7f309b784f31b525b1b1aa8bcd3` | `a736713b79199d468e10c5d03935284a1496aff87078e6520e7db26c48a8456c` |
| G10 primary | `dd01c325dba20dfa40787aa447d1cc08108785767ba1f39905904fa42f1f3c64` | `f902abca952f8b379fde2ccac003887e46cb40505cc4cc06773b5266cda71a07` |
